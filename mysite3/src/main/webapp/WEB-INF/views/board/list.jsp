			...
			<div id="board">
				...
				<div class="pager">
                    ...
                    <c:if test="${param.pageNum != pageVo.getStartPage() }">
                        <li><a href="${pageContext.request.contextPath}/board?pageNum=${param.pageNum - 1 }&amount=${pageVo.getAmount()}">◀</a></li>
                    </c:if>
					<c:forEach var="num" begin="${pageVo.getStartPage() }" end="${pageVo.getEndPage() }">
	                      <li  class="${pageVo.getPageNum() eq num ? 'selected' : '' }"> 
	                      <a href="${pageContext.request.contextPath}/board?pageNum=${num }&amount=${pageVo.getAmount()}">${num }</a></li>
                 	</c:forEach>
